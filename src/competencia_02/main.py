...
def main():
    ...
    # # Guardar ganancias
    # resultados_abril["ganancias"].to_csv(f"predict/gananciass_{STUDY_NAME}__{FINAL_PREDIC_APRIL}.csv", index=False)
    # logger.info(f"✅ CSV de ganancias guardado: predict/gananciass_{STUDY_NAME}__{FINAL_PREDIC_APRIL}.csv")
    ...
    # Guardar ganancias
    resultados_junio["ganancias"].to_csv(f"predict/gananciass_{STUDY_NAME}__{FINAL_PREDIC_JUNE}.csv", index=False)
    logger.info(f"✅ CSV de ganancias guardado: predict/gananciass_{STUDY_NAME}__{FINAL_PREDIC_JUNE}.csv")
